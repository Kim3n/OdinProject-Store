...
export default function Footer() {
    return (
        <footer
            className="flex w-full flex-col flex-wrap items-center justify-center gap-y-6 gap-x-12 border-t border-bg-gray-800 bg-gray-800 py-6 text-center md:justify-between">
