...
function ContactUs() {
    return (
        <>
            <div className="product-page flex flex-col justify-center items-center flex-1 h-full">
                <div
                    className="grid sm:grid-cols-2 items-start gap-16 p-4 mx-auto max-w-4xl bg-white font-[sans-serif] self-center">
                    <div>
                        <h1 className="text-gray-800 text-3xl font-extrabold">Let&#39;s Talk</h1>
                        <p className="text-sm text-gray-500 mt-4">Have questions, feedback, or need assistance? We’re
                            here to help! Fill out the form here, and we’ll get back to you as soon as possible.
                        </p>

                        <div className="mt-12">
                            <h2 className="text-gray-800 text-base font-bold">Alternatively, you can reach us at:</h2>
                            <ul className="mt-4">
                        ...
                        <div className="mt-12">
                            <h2 className="text-gray-800 text-base font-bold">Or find us here:</h2>
